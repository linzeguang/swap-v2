export default [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'uint256', name: 'ucoAmount', type: 'uint256' },
  ...
  { inputs: [], name: 'manualSwapAndDistribute', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [
  ...
  {
    inputs: [{ internalType: 'address', name: '_developerAddress', type: 'address' }],
